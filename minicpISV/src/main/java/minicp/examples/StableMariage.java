    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int m = 0; m < n; m++) {
            ...
            // TODO: model this with Element1D: rankWomen[m][wife[m]] == wifePref[m]
            cp.post(new Element1DDomainConsistent(rankWomen[m], wife[m], wifePref[m]));
        ...
        for (int w = 0; w < n; w++) {
            ...
            cp.post(new Element1DDomainConsistent(rankMen[w], husband[w], husbandPref[w]));
        }
